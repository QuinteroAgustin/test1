...
if(isset($submit)){
  ...
  $paysDAO = new PaysDAO();
  $paysDAO = $paysDAO->insert($pays);
  echo "Nombre de pays ajouté : ".$paysDAO ."</br>";
...
<body>
  ...
  <form action="" method="POST">
    ...
    <input type="number" name="code" id="code" value="<?= $code ?>"><br><br>

    <label for="alpha2">Alpha2</label><br>
    <input type="text" name="alpha2" id="alpha2" value="<?= $alpha2 ?>"><br><br>

    <label for="alpha3">Alpha3</label><br>
    <input type="text" name="alpha3" id="alpha3" value="<?= $alpha3 ?>"><br><br>

    <label for="nom_en">Nom (EN)</label><br>
    <input type="text" name="nom_en" id="nom_en" value="<?= $nom_en ?>"><br><br>
    
    <label for="nom_fr">Nom (FR)</label><br>
    <input type="text" name="nom_fr" id="nom_fr" value="<?= $nom_fr ?>"><br><br>
